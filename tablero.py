...
class Tablero:
    ...
    def show_score(self):
        ...
        self.high_score_image_rect.top=self.rect_screen.top+5
        ...
        self.h_level_image_rect.centerx=self.rect_screen.centerx
        ...
        for ship_number in range(self.stats.ships_left):
            ...
            ship.rect.left=5+2*ship_number*(ship.rect.width)
            self.ships.add(ship)
